...
- Visually inspect `logo-1024.png`: the full wordmark must be visible, the amber bands must align, and the glyph must read as an Iris flower with a gate opening.
